        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="trainer-item">
                    ...
                    <div class="down-content">
                        <h4>US GAAP</h4>
                        <p>Management is in charge of drafting audit reports that accurately represent true financial reporting in accordance with US GAAP standards, or Generally Accepted Accounting Principles. This refers to the development, implementation, and maintenance of financial statement preparations free from material misleading brought on by fraud or error.</p>
                    </div>
                </div>
            </div>
        </div>
