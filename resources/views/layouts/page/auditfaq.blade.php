...
<br>
<div id="accordion">
<h4>Here are the fequently asked question about Audit Service</h4>
<br>
    <div class="card">
        ...
        <div id="collapseone" class="collapse" aria-labelledby="1" data-parent="#accordion">
            <div class="card-body">
                When you request for a free consultation, a representative from Saltcoats accounting & business service will be in touch with you to understand your needs. An audit professional will be assigned to you, who will perform up to two to three audit support services based on your requirement. You will not be charged for the free trial. Only when you are satisfied with us, you may choose to commit to a contract. </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <div id="collapsefive" class="collapse" aria-labelledby="5" data-parent="#accordion">
            <div class="card-body">
                Audit outsourcing Canada is cost effective and is very competitively priced. Outsourced Audit Services in Canada are designed to help you reduce your overheads. The most important benefit is that audit outsourcing of work allows you to get the work done at a reasonably low cost and in a much more efficient way.
                <br>
        ...
        <div class="card-header" id="3">
            <h5 class="mb-0">
                <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapsethree" aria-expanded="false" aria-controls="collapseThree">
                    What are the benefits of Audit outsourcing to Canada? </button>
            </h5>
        </div>
