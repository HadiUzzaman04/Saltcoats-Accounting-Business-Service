                ...
                <section class='tabs-content'>
                    <article id='tabs-1'>
                        ...
                        <ul>
                            ...
                            <li>3. Extensive document verification</li>
                            <li>4. Preparation of working papers in accordance with ISAs</li>
                            <li>5. Preparation of HOA financial statements</li>
                            <li>6. Verification of service charges with the applicable guidelines in that country</li>
                            <li>7. Compliance with RERA applicable guidelines of that country</li>
                        </ul>
                        <br>
                        ...
                        <ul>
                            <li>1. Management</li>
                            <li>2. Monitoring</li>
                            <li>3. Maintenance of the property’s common spaces on behalf of the owners</li>
                        </ul>
                        <br>
                        <p>Normally, all Owners Associations/Body Corporates delegate management to a certified association manager. Instead of assessing the HOA’s financial transactions on your own, it is preferable to engage the help of a third-party professional who can take a good look at your monetary practice and provide an accurate overview.</p>
                    </article>
                </section>
            </div>
        </div>
