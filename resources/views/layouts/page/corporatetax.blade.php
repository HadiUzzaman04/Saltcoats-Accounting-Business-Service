...
<section class="section" id="trainers">
    <div class="container">
        ...
        <p>The following businesses will be exempt from corporate taxes:</p>
        <br>
        <div class="row">
            <div class="col-lg-6">
        ...
        <div class="row" id="tabs">
            <div class="col-lg-12">
                <section class='tabs-content'>
                    <article id='tabs-1'>
                        <h4>Exempt Income</h4>
                        <p>The following items will be excluded from corporate tax, according to the Ministry:</p>
                        <ul>
                            <li>1. Dividends and capital gains from “qualified shareholdings” obtained by a UAE corporation (i.e., ownership interest in a UAE or foreign company that meets certain conditions to be specified under the CT Law).</li>
                            <li>2. Intra-group transactions and reorganisations that qualify under the CT Law if they fulfil specified circumstances and limitations.</li>
                        </ul>
                    </article>
                </section>
            </div>
