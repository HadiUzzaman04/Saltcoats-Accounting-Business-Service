    ...
    <div class="container">
        <div class="row" id="tabs">
            <div class="col-lg-12">
                <section class='tabs-content'>
                    <article id='tabs-1'>
                        <h4>Business obligations under VAT</h4>
                        <p>Businesses need to carefully understand the dynamics of VAT compliance and business obligations. The FTA provides extensive support and guidance to assist with this. It is the responsibility of businesses however, to make sure that any required compliance obligations are fulfilled. The FTA has the power to conduct audits on taxable persons and subsequently impose penal measures on those that are not compliant with the law.</p>
                        <p>Businesses might require making changes to financial management, the technology used, core operations, human resources, and book-keeping techniques in order to fulfil the VAT obligations and comply with the FTA VAT legislation.</p>
                    </article>
                </section>
            </div>
        </div>
                ...
                <section class='tabs-content'>
                    <article id='tabs-1'>
                        ...
                        <ul>
                            ...
                            <li>3. The report separately import of services and goods announced through UAE customs.</li>
                            <li>4. Combine details as per the format of the FTA.</li>
                            <li>5. The net value of standard-rated supplies and output VAT amount must be informed after contemplating credit notes.</li>
                            <li>6. Purchases or expenses on which input VAT is restricted should not be included in Input VAT Recovery.</li>
                        </ul>
                    </article>
                </section>
            </div>
