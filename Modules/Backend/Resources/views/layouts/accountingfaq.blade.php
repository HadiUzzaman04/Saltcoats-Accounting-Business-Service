                        ...
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach($data as $key=>$accounting)
                                        <tr>
                                            <td>{{$key + 1}}</td>
                                            <td>{{$accounting->question}}</td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="btn btn-success dropdown-item" href="{{route('accountingfaq.edit',$accounting->id)}}">Edit</a>
                                                        <a class="btn btn-danger dropdown-item" onclick="return confirm('Are you sure?')" href="{{route('accountingfaq.delete',$accounting->id)}}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('accountingfaq.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
