                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="btn btn-success dropdown-item" href="{{route('auditfaq.edit',$audit->id)}}">Edit</a>
                                                        <a class="btn btn-danger dropdown-item" onclick="return confirm('Are you sure?')" href="{{route('auditfaq.delete',$audit->id)}}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('auditfaq.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
